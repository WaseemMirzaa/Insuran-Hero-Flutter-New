...
class _QuestionViewState extends State<QuestionView> with SingleTickerProviderStateMixin {
  ...
  void _nextQuestion() {
    setState(() {
      _questionIndex <= widget.paper.questions!.length ? _questionIndex++ : null;
      isSelected = -1;
  ...
  void _resetQuiz() {
    ...
    addQuizzInHistory(quizHistoryModel);
    setState(() {
      _questionIndex = 0;
      _totalScore = 0;
    });
    showsDialogue_Completed();
  }
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      onWillPop:() async  {
        return showsDialogue_CloseTheQuiz(context);
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          leading: IconButton(
            onPressed: () {
              showsDialogue_CloseTheQuiz(context);
        ...
        body: Container(
          ...
          child: Padding(
            padding: EdgeInsets.symmetric(
                horizontal: Gaps.horizontalPadding, vertical: Gaps.verticalPadding),
            child: Stack(
              children: [
                SingleChildScrollView(
                  child: Column(
                      ...
                      children: [
                        Text(
                          QuestionModel.fromMap(widget.paper.questions![_questionIndex]).question ??
                              "",
                            ...
                            ? Row(
                                ...
                                children: [
                                  ...
                                  IconButton(
                                      ...
                                      icon:
                                          Icon(index == 0 ? Icons.visibility_off : Icons.visibility))
                                ],
                              )
                            : Container(),
                        verticalGap(25),
                        Align(
                          ...
                          child: CircularPercentIndicator(
                            ...
                            center: TweenAnimationBuilder<Duration>(
                                ...
                                tween: Tween(
                                    begin: Duration(milliseconds: widget.paper.time! * 1000),
                                    end: Duration.zero),
                                onEnd: () {
                                  QuizHistoryModel quizHistoryModel = QuizHistoryModel(
                                      questions: quizzQuestions,
                        ...
                        ListView.builder(
                            ...
                            itemBuilder: ((context, index) {
                              List<String> answers = [];
                              answers.add(
                                  QuestionModel.fromMap(widget.paper.questions![_questionIndex]).A ??
                                      "");
                              answers.add(
                                  QuestionModel.fromMap(widget.paper.questions![_questionIndex]).B ??
                                      "");
                              answers.add(
                                  QuestionModel.fromMap(widget.paper.questions![_questionIndex]).C ??
                                      "");
                              answers.add(
                                  QuestionModel.fromMap(widget.paper.questions![_questionIndex]).D ??
                                      "");
                              correctAns =
                                  QuestionModel.fromMap(widget.paper.questions![_questionIndex])
                                          .correctAns ??
                                      "";
                              return Answer(
                                  ...
                                  answerTap: () {
                                    ...
                                    print(_totalScore.toString() + "total scores are");
                                  });
                            })),
                        SizedBox(
                          height: 30,
                      ...
                      onPressed: () {
                        if (isSelected != -1) {
                          ...
                          QuestionModel question = QuestionModel(
                              ...
                              question: QuestionModel.fromMap(widget.paper.questions![_questionIndex])
                                  .question);
  ...
  Future<bool> showsDialogue_CloseTheQuiz(BuildContext? context) async {
    return await showDialog(
      context: context!,
      builder: (context) => AlertDialog(
        title: const Text('Quit'),
        content: const Text('Do you want to quit? You will not be able to re attempt it later.'),
        actions: [
          ElevatedButton(
            style: ButtonStyle(
